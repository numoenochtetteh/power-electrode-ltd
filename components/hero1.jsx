...
export function Hero1() {
  return (
    <section className="bg-white px-3 pb-5 pt-1 sm:px-5 sm:pb-7 lg:px-8">
      <div className="relative mx-auto min-h-[590px] max-w-[1800px] overflow-hidden rounded-none bg-slate-950 sm:min-h-[610px] sm:rounded-[28px] lg:min-h-[570px] lg:rounded-[34px]">
        {/* Background video */}
        <video
